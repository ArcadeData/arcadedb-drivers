...
from ..models.grafana_query_request_targets_item_aggregation_requests_item_type import (
...
class GrafanaQueryRequestTargetsItemAggregationRequestsItem:
    ...
    Attributes:
        ...
        type_ (GrafanaQueryRequestTargetsItemAggregationRequestsItemType): Aggregation function, matched case-
    ...
    field: str
    type_: GrafanaQueryRequestTargetsItemAggregationRequestsItemType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GrafanaQueryRequestTargetsItemAggregationRequestsItemType(d.pop("type"))
