...
T = TypeVar("T", bound="McpConfigUpdateDatabases")


@_attrs_define
class McpConfigUpdateDatabases:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        mcp_config_update_databases = cls()
        ...
        mcp_config_update_databases.additional_properties = additional_properties
        return mcp_config_update_databases
